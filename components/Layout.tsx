  ...
  return (
    <div className="flex min-h-screen bg-gray-100 font-sans text-gray-900">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden md:ml-64 transition-all duration-300">
        ...
        {/* Top Header */}
        <header className="bg-white shadow-sm border-b border-gray-200 px-4 md:px-6 py-3 flex justify-between items-center z-30 sticky top-0">
        ...
        {/* Main Content */}
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 scroll-smooth">
          {children}
        </main>
      </div>
    </div>
