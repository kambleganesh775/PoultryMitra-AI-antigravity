...
const GuidesSection: React.FC = () => {
  ...
  return (
    <div className="p-4 md:p-6 pb-20 md:pb-6">
      <h1 className="text-xl md:text-2xl font-bold text-gray-800 mb-6">Farming Guides & SOPs</h1>
                ...
                <div className="bg-orange-50 p-4 rounded-xl border border-orange-100 mb-6">
                    ...
                    {weatherLoading ? (
                        <div className="flex items-center gap-2 py-4 text-orange-600 text-sm">
                            <Loader2 size={16} className="animate-spin"/> Analyzing local environment...
                        </div>
                    ) : weatherAdvice ? (
                        <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="bg-white p-3 rounded-lg shadow-sm border-l-4 border-orange-400">
                                <p className="text-xs text-orange-600 font-bold uppercase mb-1">Safe Brooding Tip</p>
                                <p className="text-sm text-gray-800 font-medium leading-relaxed">{weatherAdvice.broodingTip}</p>
                            </div>
                        </div>
                    ) : (
                        <div className="mt-3 text-sm text-orange-700 italic flex justify-between items-center">
                            <span>Click refresh for live AI advice.</span>
                            <button onClick={handleCheckWeather} className="bg-orange-600 text-white px-3 py-1 rounded text-xs">Load Advice</button>
                        </div>
                    )}
                </div>
