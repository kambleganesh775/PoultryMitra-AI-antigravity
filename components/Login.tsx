      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-orange-100">
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4 mb-6">
          ...
          <button
            ...
            className="w-full bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 rounded-lg flex justify-center items-center gap-2 transition-colors disabled:opacity-50 touch-manipulation shadow-md"
          >
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 text-center">
          <p className="text-xs text-gray-400">
            ...
            Your data is securely stored offline locally.
          </p>
        </div>
      </div>
    </div>
