...
const BreedAnalytics: React.FC = () => {
  return (
    <div className="p-4 md:p-6 pb-20 md:pb-6">
      <h1 className="text-xl md:text-2xl font-bold text-gray-800 mb-6">Breed Growth & Profit Dashboard</h1>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
        
        {/* Weight Comparison Chart */}
        <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-gray-200 h-72 md:h-96">
      ...
      <div className="mt-8 bg-yellow-50 p-4 md:p-6 rounded-xl border border-yellow-200">
        <h3 className="font-bold text-yellow-900 text-lg mb-4">💡 Strategy Insights</h3>
